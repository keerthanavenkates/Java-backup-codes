...
public void Method1() throws InterruptedException{
	...
	Actions a = new Actions(driver);
		...
		WebElement newTab =  driver.findElement(By.xpath("//div[text()='SAMSUNG The Frame 2021 Series 163 cm (65 inch) QLED Ultra HD (4K) Smart Tizen TV'][1]"));
